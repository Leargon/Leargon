...
#### USER STORY 'Pace the to-do rules to our maturity'
**AS AN** admin\
**IF** our organisation is early in its governance journey and cannot close every gap at once\
**I WANT** to switch individual to-do rules off, or mark them as optional rather than required, and
to apply a maturity preset that enables a whole tier at once\
**SO THAT** owners see an achievable list rather than every gap the platform can detect

#### USER STORY 'Keep a dismissed to-do honest'
