 ...
 */
export const exportProcessingRegister = async (params?: ExportProcessingRegisterParams, options?: Parameters<typeof customAxios>[1]): Promise<exportProcessingRegisterResponse> => {
 ...
 */
export const exportServiceProviders = async (params?: ExportServiceProvidersParams, options?: Parameters<typeof customAxios>[1]): Promise<exportServiceProvidersResponse> => {
 ...
 */
export const exportDpiaRegister = async ( options?: Parameters<typeof customAxios>[1]): Promise<exportDpiaRegisterResponse> => {
 ...
 */
export const exportBusinessDataQualityRules = async ( options?: Parameters<typeof customAxios>[1]): Promise<exportBusinessDataQualityRulesResponse> => {
