...
export const setBusinessEntityFieldVerification = async (key: string,
    setFieldVerificationRequest: SetFieldVerificationRequest, options?: RequestInit): Promise<setBusinessEntityFieldVerificationResponse> => {
...
export const getSetBusinessEntityFieldVerificationMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setBusinessEntityFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext>, request?: SecondParameter<typeof customAxios>}
): UseMutationOptions<Awaited<ReturnType<typeof setBusinessEntityFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext> => {

const mutationKey = ['setBusinessEntityFieldVerification'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setBusinessEntityFieldVerification>>, {key: string;data: SetFieldVerificationRequest}> = (props) => {
          const {key,data} = props ?? {};
...
export const useSetBusinessEntityFieldVerification = <TError = void,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {key: string;data: SetFieldVerificationRequest},
        TContext
      > => {
