...
export const setBusinessDomainFieldVerification = async (key: string,
    setFieldVerificationRequest: SetFieldVerificationRequest, options?: RequestInit): Promise<setBusinessDomainFieldVerificationResponse> => {
...
export const getSetBusinessDomainFieldVerificationMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setBusinessDomainFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext>, request?: SecondParameter<typeof customAxios>}
): UseMutationOptions<Awaited<ReturnType<typeof setBusinessDomainFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext> => {

const mutationKey = ['setBusinessDomainFieldVerification'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setBusinessDomainFieldVerification>>, {key: string;data: SetFieldVerificationRequest}> = (props) => {
