 ...
 */
export const getProcessingRegister = async (params?: GetProcessingRegisterParams, options?: Parameters<typeof customAxios>[1]): Promise<getProcessingRegisterResponse> => {
