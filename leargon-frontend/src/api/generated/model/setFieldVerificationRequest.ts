 ...
 */
import type { SetFieldVerificationRequestStatus } from './setFieldVerificationRequestStatus.ts';

export interface SetFieldVerificationRequest {
  /** Configurable field name to set the status for */
  fieldName: string;
  /** New verification status (owner may set either) */
  status: SetFieldVerificationRequestStatus;
}
