...
import type { TeamInteractionDuration } from './teamInteractionDuration.ts';
import type { TeamInteractionMode } from './teamInteractionMode.ts';

export interface TeamInteractionResponse {
  id: number;
  sourceUnit: OrganisationalUnitSummaryResponse;
  targetUnit: OrganisationalUnitSummaryResponse;
  mode: TeamInteractionMode;
  duration: TeamInteractionDuration;
  /**
     * Current interaction health (1 = poor, 5 = healthy)
     * @minimum 1
     * @maximum 5
     * @nullable
     */
