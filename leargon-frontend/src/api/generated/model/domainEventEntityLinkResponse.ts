...
import type { DomainEventEntityLinkType } from './domainEventEntityLinkType.ts';

export interface DomainEventEntityLinkResponse {
  id: number;
  entity: BusinessEntitySummaryResponse;
