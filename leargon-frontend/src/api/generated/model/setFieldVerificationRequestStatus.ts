 ...
 */
export type SetFieldVerificationRequestStatus = typeof SetFieldVerificationRequestStatus[keyof typeof SetFieldVerificationRequestStatus];


export const SetFieldVerificationRequestStatus = {
  VERIFIED: 'VERIFIED',
