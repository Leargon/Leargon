 ...
 */
export type FieldConfigurationEntryMaturityLevel = typeof FieldConfigurationEntryMaturityLevel[keyof typeof FieldConfigurationEntryMaturityLevel];


export const FieldConfigurationEntryMaturityLevel = {
  BASIC: 'BASIC',
  ADVANCED: 'ADVANCED',
  EXPERT: 'EXPERT',
} as const;
