...
import type { BusinessDomainTranslationInput } from './businessDomainTranslationInput';

export interface UpdateBusinessDomainRequest {
  /**
   * New parent domain ID (null for top-level domain)
   * @nullable
   */
  parentId?: number | null;
  type?: BusinessDomainType;
  /** Updated names (replaces all existing names) */
  names?: BusinessDomainTranslationInput[];
}
