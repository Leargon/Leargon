...
/**
 * Under a picked parent, into a picked container, or at top level
 */
export type AdvisorPlacementType = typeof AdvisorPlacementType[keyof typeof AdvisorPlacementType];


export const AdvisorPlacementType = {
  CHILD: 'CHILD',
  NEW_ROOT: 'NEW_ROOT',
  TOP_LEVEL: 'TOP_LEVEL',
} as const;
