 ...
 * @nullable
 */
export type CreateBusinessDataQualityRuleRequestSeverity = typeof CreateBusinessDataQualityRuleRequestSeverity[keyof typeof CreateBusinessDataQualityRuleRequestSeverity] | null;


export const CreateBusinessDataQualityRuleRequestSeverity = {
  MUST: 'MUST',
  SHOULD: 'SHOULD',
  MAY: 'MAY',
} as const;
