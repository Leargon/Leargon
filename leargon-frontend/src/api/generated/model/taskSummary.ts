...
export interface TaskSummary {
  /** Number of open (non-dismissed) tasks */
  open: number;
  required: number;
  recommended: number;
  /** Total number of rule checks run across the user's items */
  checksEvaluated: number;
  /** Number of checks that passed (no task raised) */
  checksPassed: number;
  /**
     * checksPassed / checksEvaluated * 100; null when nothing was evaluated
     * @nullable
     */
