...
/**
 * Why the current user may create at a place (admin, methodology editor, or which realm grants it)
 */
export type CreationBasis = typeof CreationBasis[keyof typeof CreationBasis];


export const CreationBasis = {
  ADMIN: 'ADMIN',
  METHODOLOGY_EDITOR: 'METHODOLOGY_EDITOR',
