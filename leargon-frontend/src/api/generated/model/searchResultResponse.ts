...
import type { SearchResultResponseMatchedIn } from './searchResultResponseMatchedIn.ts';
import type { SearchResultType } from './searchResultType.ts';

export interface SearchResultResponse {
  type?: SearchResultType;
  key?: string;
  names?: LocalizedText[];
  matchedIn?: SearchResultResponseMatchedIn;
}
