 ...
 */
import type { ConwaysLawAlignmentDomainNames } from './conwaysLawAlignmentDomainNames.ts';
import type { ConwaysLawAlignmentOrgUnitNames } from './conwaysLawAlignmentOrgUnitNames.ts';
import type { ConwaysLawCell } from './conwaysLawCell.ts';

export interface ConwaysLawAlignment {
  domainKeys: string[];
  orgUnitKeys: string[];
  domainNames: ConwaysLawAlignmentDomainNames;
  orgUnitNames: ConwaysLawAlignmentOrgUnitNames;
  cells: ConwaysLawCell[];
}
