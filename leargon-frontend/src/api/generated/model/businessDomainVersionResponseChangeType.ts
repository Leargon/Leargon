 ...
 * Type of change
 */
export type BusinessDomainVersionResponseChangeType = typeof BusinessDomainVersionResponseChangeType[keyof typeof BusinessDomainVersionResponseChangeType];


export const BusinessDomainVersionResponseChangeType = {
  CREATE: 'CREATE',
  UPDATE: 'UPDATE',
