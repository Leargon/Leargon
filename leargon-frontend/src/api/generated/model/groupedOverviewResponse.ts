 ...
 */
import type { OverviewGroup } from './overviewGroup.ts';
import type { OverviewResourceType } from './overviewResourceType.ts';

export interface GroupedOverviewResponse {
  resourceType: OverviewResourceType;
  /** The dimension the list was grouped by */
  groupBy: string;
  /** Groups in display order, with the unassigned group last */
