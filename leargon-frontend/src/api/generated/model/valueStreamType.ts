...
/**
 * VSM: role of this step in the value stream
 * @nullable
 */
export type ValueStreamType = typeof ValueStreamType[keyof typeof ValueStreamType] | null;


export const ValueStreamType = {
  ENABLING: 'ENABLING',
