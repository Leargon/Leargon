 ...
 */
import type { SaveFlowNodeRequest } from './saveFlowNodeRequest.ts';
import type { SaveFlowTrackRequest } from './saveFlowTrackRequest.ts';

export interface SaveProcessFlowRequest {
  nodes: SaveFlowNodeRequest[];
  tracks: SaveFlowTrackRequest[];
}
