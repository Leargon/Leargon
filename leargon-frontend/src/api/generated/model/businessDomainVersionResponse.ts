 ...
 */
import type { BusinessDomainVersionResponseChangeType } from './businessDomainVersionResponseChangeType.ts';
import type { UserSummaryResponse } from './userSummaryResponse.ts';

export interface BusinessDomainVersionResponse {
  /** Version number */
  versionNumber: number;
  changedBy: UserSummaryResponse;
  /** Type of change */
  changeType: BusinessDomainVersionResponseChangeType;
  /**
