 ...
 */
import type { AdvisorAnswerType } from './advisorAnswerType.ts';
import type { AdvisorPickerItem } from './advisorPickerItem.ts';
import type { AdvisorQuestionParams } from './advisorQuestionParams.ts';
...
export interface AdvisorQuestion {
  ...
  options: string[];
  pickerItems: AdvisorPickerItem[];
  pickerItemType?: CreatableItemType;
  /** Values for the question text, e.g. `picked` — the name of the item picked last */
  params?: AdvisorQuestionParams;
}
