 ...
 */
import type { DomainEventLinkType } from './domainEventLinkType.ts';
import type { ProcessSummaryResponse } from './processSummaryResponse.ts';

export interface DomainEventProcessLinkResponse {
  id: number;
  process: ProcessSummaryResponse;
  linkType: DomainEventLinkType;
}
