...
export type DuplicateCandidateMatchType = typeof DuplicateCandidateMatchType[keyof typeof DuplicateCandidateMatchType];


export const DuplicateCandidateMatchType = {
  EXACT: 'EXACT',
  SIMILAR: 'SIMILAR',
} as const;
