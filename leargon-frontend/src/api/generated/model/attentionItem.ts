 ...
 */
import type { AttentionItemIssueCode } from './attentionItemIssueCode.ts';
import type { AttentionItemResourceType } from './attentionItemResourceType.ts';
import type { AttentionItemSeverity } from './attentionItemSeverity.ts';

export interface AttentionItem {
  resourceType: AttentionItemResourceType;
  key: string;
  name: string;
  /** Machine-readable issue code */
  issueCode: AttentionItemIssueCode;
