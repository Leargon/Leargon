 ...
 * @nullable
 */
export type UpdateBusinessDataQualityRuleRequestSeverity = typeof UpdateBusinessDataQualityRuleRequestSeverity[keyof typeof UpdateBusinessDataQualityRuleRequestSeverity] | null;


export const UpdateBusinessDataQualityRuleRequestSeverity = {
  MUST: 'MUST',
  SHOULD: 'SHOULD',
  MAY: 'MAY',
} as const;
