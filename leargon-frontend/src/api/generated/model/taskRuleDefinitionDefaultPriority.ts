...
export type TaskRuleDefinitionDefaultPriority = typeof TaskRuleDefinitionDefaultPriority[keyof typeof TaskRuleDefinitionDefaultPriority];


export const TaskRuleDefinitionDefaultPriority = {
  REQUIRED: 'REQUIRED',
