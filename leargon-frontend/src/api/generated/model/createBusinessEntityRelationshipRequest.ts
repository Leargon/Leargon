...
export interface CreateBusinessEntityRelationshipRequest {
  /** Key of the second entity in the relationship */
  secondEntityKey: string;
  /** Minimum cardinality of the first entity */
  firstCardinalityMinimum: number;
  /**
   * Maximum cardinality of the first entity (null = unbounded)
   * @nullable
   */
  firstCardinalityMaximum?: number | null;
  /** Minimum cardinality of the second entity */
  secondCardinalityMinimum: number;
  /**
   * Maximum cardinality of the second entity (null = unbounded)
   * @nullable
   */
