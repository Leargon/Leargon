 ...
 */
import type { ActivityItem } from './activityItem.ts';
import type { AttentionItem } from './attentionItem.ts';
import type { MyResponsibilitiesResponse } from './myResponsibilitiesResponse.ts';

export interface DashboardResponse {
  needsAttention: AttentionItem[];
  recentActivity: ActivityItem[];
  myResponsibilities: MyResponsibilitiesResponse;
}
