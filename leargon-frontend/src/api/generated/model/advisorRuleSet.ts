 ...
 */
import type { AdvisorOutcomeDef } from './advisorOutcomeDef.ts';
import type { AdvisorQuestionDef } from './advisorQuestionDef.ts';
...
export interface AdvisorRuleSet {
  ...
  rootQuestion: string;
  questions: AdvisorQuestionDef[];
  outcomes: AdvisorOutcomeDef[];
  /** @nullable */
