...
export type BusinessEntityRelationshipResponseCardinalityItem = {
  businessEntity: BusinessEntitySummaryResponse;
  /**
   * Minimum cardinality of first named Business Entity
   */
  minimum: number;
  /**
   * Maximum cardinality of first named Business Entity
   * @nullable
   */
  maximum?: number | null;
};
