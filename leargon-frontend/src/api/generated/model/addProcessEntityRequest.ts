 ...
 */
import type { CreateBusinessEntityRequest } from './createBusinessEntityRequest.ts';

export interface AddProcessEntityRequest {
  /**
     * Key of an existing business entity
     * @nullable
     */
  entityKey?: string | null;
  createEntity?: CreateBusinessEntityRequest;
}
