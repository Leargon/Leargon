...
export type TaskRuleDefinitionMaturityLevel = typeof TaskRuleDefinitionMaturityLevel[keyof typeof TaskRuleDefinitionMaturityLevel];


export const TaskRuleDefinitionMaturityLevel = {
  BASIC: 'BASIC',
  ADVANCED: 'ADVANCED',
  EXPERT: 'EXPERT',
} as const;
