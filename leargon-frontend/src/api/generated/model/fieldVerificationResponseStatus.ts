 ...
 */
export type FieldVerificationResponseStatus = typeof FieldVerificationResponseStatus[keyof typeof FieldVerificationResponseStatus];


export const FieldVerificationResponseStatus = {
  VERIFIED: 'VERIFIED',
