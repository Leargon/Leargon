 ...
 */
import type { AdvisorEvaluateResponseStatus } from './advisorEvaluateResponseStatus.ts';
import type { AdvisorQuestion } from './advisorQuestion.ts';
import type { AdvisorRecommendation } from './advisorRecommendation.ts';
import type { DuplicateCandidate } from './duplicateCandidate.ts';

export interface AdvisorEvaluateResponse {
  status: AdvisorEvaluateResponseStatus;
  /** Codes of the questions answered so far, in order */
  answeredPath: string[];
