 ...
 */
import type { BusinessEntityRelationshipResponseCardinalityItem } from './businessEntityRelationshipResponseCardinalityItem.ts';
...
export interface BusinessEntityRelationshipResponse {
  ...
  /**
     ...
     * @maxItems 2
     */
  cardinality?: BusinessEntityRelationshipResponseCardinalityItem[];
}
