...
export interface ConwaysLawMisalignmentItem {
  processKey: string;
  processName: string;
  boundedContextKey: string;
  boundedContextName: string;
  executingUnitKey: string;
  executingUnitName: string;
  /** The bounded context the team is formally assigned to */
  teamBoundedContextKey: string;
  teamBoundedContextName: string;
}
