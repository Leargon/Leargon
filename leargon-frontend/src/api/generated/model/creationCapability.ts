...
export interface CreationCapability {
  ...
  /** The user may create this item type from its list — at top level, or inside a realm container they own (bounded context, domain, owning unit). Children of an owned item are created via the parent's `creatableChildTypes` instead. */
  canCreate: boolean;
  /** The user may create this item type at top level / without a placement (admin or methodology editor) */
