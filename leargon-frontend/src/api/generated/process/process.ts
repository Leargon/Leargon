...
export const setProcessFieldVerification = async (key: string,
    setFieldVerificationRequest: SetFieldVerificationRequest, options?: RequestInit): Promise<setProcessFieldVerificationResponse> => {
...
export const getSetProcessFieldVerificationMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setProcessFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext>, request?: SecondParameter<typeof customAxios>}
): UseMutationOptions<Awaited<ReturnType<typeof setProcessFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext> => {

const mutationKey = ['setProcessFieldVerification'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setProcessFieldVerification>>, {key: string;data: SetFieldVerificationRequest}> = (props) => {
          const {key,data} = props ?? {};
