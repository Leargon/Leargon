...
export const setOrganisationalUnitFieldVerification = async (key: string,
    setFieldVerificationRequest: SetFieldVerificationRequest, options?: RequestInit): Promise<setOrganisationalUnitFieldVerificationResponse> => {
...
export const getSetOrganisationalUnitFieldVerificationMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setOrganisationalUnitFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext>, request?: SecondParameter<typeof customAxios>}
): UseMutationOptions<Awaited<ReturnType<typeof setOrganisationalUnitFieldVerification>>, TError,{key: string;data: SetFieldVerificationRequest}, TContext> => {

const mutationKey = ['setOrganisationalUnitFieldVerification'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setOrganisationalUnitFieldVerification>>, {key: string;data: SetFieldVerificationRequest}> = (props) => {
