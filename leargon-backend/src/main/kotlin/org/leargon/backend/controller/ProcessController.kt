...
open class ProcessController(
    ...
    override fun updateProcessNames(
        key: String,
    ...
    override fun updateProcessDescriptions(
        key: String,
    ...
    override fun updateProcessType(
        key: String,
        @Valid @Body request: UpdateProcessTypeRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
        return processService.updateProcessType(key, request.processType?.value, currentUser)
    }

    override fun updateProcessLegalBasis(
        key: String,
        @Valid @Body request: UpdateProcessLegalBasisRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
        return processService.updateLegalBasis(key, request.legalBasis?.value, currentUser)
    }

    override fun updateProcessPurpose(
        key: String,
        @Valid @Body request: UpdateProcessPurposeRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
        return processService.updatePurpose(key, request.purpose, currentUser)
    }

    override fun updateProcessSecurityMeasures(
        key: String,
        @Valid @Body request: UpdateProcessSecurityMeasuresRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
    ...
    override fun updateProcessCode(
        key: String,
        @Valid @Body request: UpdateProcessCodeRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
    ...
    override fun assignBoundedContextToProcess(
        key: String,
        @Valid @Body request: AssignBoundedContextRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
    ...
    override fun assignClassificationsToProcess(
        key: String,
        @Valid @Body assignments: List<ClassificationAssignmentRequest>
    ): ProcessResponse {
        val currentUser = getCurrentUser()
    ...
    override fun getProcessVersions(key: String): List<ProcessVersionResponse> = processService.getVersionHistory(key)

    override fun getProcessVersionDiff(
        key: String,
        versionNumber: Int
    ): VersionDiffResponse = processService.getVersionDiff(key, versionNumber)

    override fun addProcessInput(
        key: String,
        @Valid @Body request: AddProcessEntityRequest
    ): ProcessResponse {
        val currentUser = getCurrentUser()
        return processService.addInput(key, request, currentUser)
    }

    override fun removeProcessInput(
        key: String,
        entityKey: String
    ): ProcessResponse {
        val currentUser = getCurrentUser()
    ...
    override fun removeProcessOutput(
        key: String,
        entityKey: String
    ): ProcessResponse {
        val currentUser = getCurrentUser()
    ...
    override fun assignExecutingUnits(
        key: String,
    ...
    override fun updateProcessCrossBorderTransfers(
        key: String,
    ...
    override fun updateProcessItSystems(
        key: String,
        @Valid @Body updateProcessItSystemsRequest: UpdateProcessItSystemsRequest
    ): HttpResponse<Void> {
        itSystemService.updateProcessItSystems(key, updateProcessItSystemsRequest)
        return HttpResponse.noContent()
    }

    override fun getProcessDpia(key: String): DpiaResponse = dpiaService.getDpiaForProcess(key)
