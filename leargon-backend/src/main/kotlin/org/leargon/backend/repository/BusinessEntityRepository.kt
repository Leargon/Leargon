...
interface BusinessEntityRepository : JpaRepository<BusinessEntity, Long> {
    ...
    @Join(value = "owningUnit.businessOwner", type = Join.Type.LEFT_FETCH)
    @Join(value = "owningUnit.businessSteward", type = Join.Type.LEFT_FETCH)
    @Join(value = "owningUnit.technicalCustodian", type = Join.Type.LEFT_FETCH)
    ...
    @Join(value = "boundedContext.domain.owningUnit", type = Join.Type.LEFT_FETCH)
    @Join(value = "boundedContext.domain.owningUnit.businessOwner", type = Join.Type.LEFT_FETCH)
    @Join(value = "boundedContext.domain.owningUnit.businessSteward", type = Join.Type.LEFT_FETCH)
    @Join(value = "boundedContext.domain.owningUnit.technicalCustodian", type = Join.Type.LEFT_FETCH)
